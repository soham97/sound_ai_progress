...
| :--- | :--- | :--- | :--- | :--- |
| <sub>**BEATs: Audio Pre-Training with Acoustic Tokenizers**</sub> | <sub>iterative audio pre-training framework to learn bidirectional encoder representation from audio transformers [ensemble]</sub> | <sub>0.506</sub> | <sub>[chen22](https://arxiv.org/pdf/2212.09058.pdf)</sub> | <a href="https://github.com/microsoft/unilm/tree/master/beats">:scroll:</a> |
